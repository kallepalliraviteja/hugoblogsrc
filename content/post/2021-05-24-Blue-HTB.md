...
title = "Hacking Blue Machine"
date = "2021-05-13"
description = "Hacking the Hack The Box Blue Machine."
categories = [
    "Pentesting",
]
+++
In this post i will walk you through the process in which i have rooted BLUE Machine on Hack The Box. 
<!--more-->
### Hello every one!
...
{{< figure src="/images/Blue.jpg" title="HTB-Blue" >}}
